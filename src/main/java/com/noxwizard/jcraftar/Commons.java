...
class Commons {
    ...
    static JSONArray getObjectList(String apiKey, String objectType, int limit, int offset, JSONObject filter)
        ...
        try (CloseableHttpClient client = HttpClients.custom().setSSLSocketFactory(getSSLContext()).build()) {
    ...
    static int countObjectsInList(String apiKey, String objectType, JSONObject filter)
            throws CatchoomException, IOException, NoSuchAlgorithmException {
        int count;
    ...
    static JSONObject getObject(String apiKey, String objectType, String uuid)
            throws CatchoomException, IOException, NoSuchAlgorithmException {
    ...
    static JSONObject createObject(String apiKey, String objectType, JSONObject data)
            throws CatchoomException, IOException, NoSuchAlgorithmException {
        JSONObject jResponse;
    ...
    static JSONObject createObjectMultipart(String apiKey, String objectType, File file, JSONObject data)
            throws CatchoomException, IOException, NoSuchAlgorithmException {
        JSONObject jResponse;
        validate(objectType, data, null);
        String url = getUrl(apiKey, objectType, null, -1, -1, null);
    ...
    static JSONObject updateObject(String apiKey, String objectType, String uuid, JSONObject data)
            throws CatchoomException, IOException, NoSuchAlgorithmException {
    ...
    static JSONObject updateObjectMultipart(String apiKey, String objectType, String uuid, File file, JSONObject data)
            throws CatchoomException, IOException, NoSuchAlgorithmException {
        JSONObject jResponse;
        validate(objectType, data, uuid);
        String url = getUrl(apiKey, objectType, uuid, -1, -1, null);
    ...
    static JSONObject deleteObject(String apiKey, String objectType, String uuid)
            throws CatchoomException, IOException, NoSuchAlgorithmException {
        JSONObject jResponse = new JSONObject();
        validate(objectType, null, uuid);
        String url = getUrl(apiKey, objectType, uuid, -1, -1, null);
